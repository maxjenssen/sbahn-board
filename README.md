...
| Shows | Meaning |
|---|---|
| `S1 7` / `S1.7` | Next city-bound S1 leaves in 7 min — this is the *actual* (delay-included) countdown; a dot blinking at 1 Hz means the train is running late vs its schedule |
